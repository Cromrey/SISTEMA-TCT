...
export const createNewProjectPhases = (eventDate: string, includesPhotobook = true): PhaseData[] => {
      ...
      steps: [
        {
          ...
          status: 'in_progress',
          checklist: [
            { id: 'c1_1', text: 'Emisión de presupuesto formal membretado TCT', completed: false },
            { id: 'c1_2', text: 'Asignación de Código de Seguimiento exclusivo', completed: false },
            { id: 'c1_3', text: 'Aceptación de propuesta económica por el cliente', completed: false }
          ]
        },
        {
          stepNumber: 2,
          ...
          status: 'pending',
          checklist: [
            { id: 'c2_1', text: 'Recepción del pago inicial de adelanto', completed: false },
            { id: 'c2_2', text: 'Congelamiento oficial de la fecha en la agenda de filmación', completed: false },
            { id: 'c2_3', text: 'Emisión de recibo / comprobante de caja Corporación TCT', completed: false }
          ]
        },
        {
          stepNumber: 3,
          ...
          status: 'pending',
          checklist: [
            { id: 'c3_1', text: 'Firma formal del acuerdo legal especificando N° Cotización y Contrato', completed: false },
            { id: 'c3_2', text: 'Aprobación de cláusula de pago y tiempos de entrega', completed: false },
